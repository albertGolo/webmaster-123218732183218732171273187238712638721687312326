...
<div class="palette" id="colors" style="display:none;">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="tabs nav-pills nav-fill w mb-4" role="tablist">
                        @foreach (config('site.character_editor_item_types') as $type)
                            <li class="nav-item">
                                <span class="tab-link @if ($type == 'hat') active @endif squish" data-tab="{{ lcfirst(itemType($type, true)) }}">{{ itemType($type, true) }}</span>
                            </li>
                        @endforeach
                    </ul>
