...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <ul class="tabs  nav-pills nav-justified" role="tablist">
                <li class="nav-item">
                    <a href="{{ route('account.money.index', 'general') }}" class="tab-link @if ($category == 'general') active @endif squish">General</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('account.money.index', 'purchases') }}" class="tab-link @if ($category == 'purchases') active @endif squish">Purchases</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('account.money.index', 'sales') }}" class="tab-link @if ($category == 'sales') active @endif squish">Sales</a>
                </li>
            </ul>
        </div>
    </div>
