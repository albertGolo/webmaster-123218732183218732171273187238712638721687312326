    ...
    <div class="card">
        <div class="card-body">
            <ul class="tabs nav-pills nav-justified" role="tablist">
                <li class="nav-item">
                    <a href="{{ route('account.trades.index', 'incoming') }}" class="tab-link @if ($category == 'incoming') active @endif squish">Incoming</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('account.trades.index', 'sent') }}" class="tab-link @if ($category == 'sent') active @endif squish">Sent</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('account.trades.index', 'history') }}" class="tab-link @if ($category == 'history') active @endif squish">History</a>
                </li>
            </ul>
        </div>
    </div>
