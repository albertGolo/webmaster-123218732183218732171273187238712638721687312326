...
@section('content')
            ...
            <form action="{{ route('groups.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <textarea class="form" name="description" placeholder="Description" rows="10">{{ $group->description }}</textarea>
                    </div>
                </div>
    ...
    <div class="card">
        <div class="card-body">
            <ul class="tabs nav-pills nav-justified">
                <li class="tab-link">
                    <span href="#membersTab" class="tab-item squish" data-toggle="tab">Members</span>
                </li>
                @if ($group->is_private)
                    <li class="tab-link">
                        <span href="#joinRequestsTab" class="tab-item squish" data-toggle="tab">Join Requests</span>
                    </li>
                @endif
                <li class="tab-link">
                    <span href="#vaultTab" class="tab-item squish" data-toggle="tab">Vault</span>
                </li>
                <li class="tab-link">
                    <span href="#settingsTab" class=" tab-item squish" data-toggle="tab">Settings</span>
                </li>
            </ul>
        </div>
    </div>
