                ...
                <div class="card-body">
                    <form action="{{ route('creator_area.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if ($isGroup)
                            ...
                            <input class="form mb-2" type="text" name="name" placeholder="Space Name" required>
                        ...
                        @else
                            ...
                            <label for="name">Name</label>
                            <input class="form mb-2" type="text" name="name" placeholder="Item Name" required>
                            <label for="description">Description</label>
                            <textarea class="form mb-2" name="description" placeholder="Item Description" rows="5"></textarea>
                            ...
                            <input class="form mb-2" type="number" name="price" placeholder="Item Price" min="0" max="1000000">
