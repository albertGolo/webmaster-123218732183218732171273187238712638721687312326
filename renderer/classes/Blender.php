...
class Blender
{
    ...
    public function execute($tmpFilename)
    {
        ...
        exec(escapeshellcmd("/var/www/aeo-blender/blender --background --python {$tmpFile}"));
    }
    ...
    public function setTexture($var, $object, $filename)
    {
        ...
        $texture = ($filename == 'default') ? "{$directories['ROOT']}/img/facerwowwza.png" : "{$directories['UPLOADS']}/{$filename}.png";
