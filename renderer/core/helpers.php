...
{
    if ($var4)
        return $GLOBALS['config'][$var1][$var2][$var3][$var4] ?? null;
    else if ($var3)
        return $GLOBALS['config'][$var1][$var2][$var3] ?? null;
    else if ($var2)
        return $GLOBALS['config'][$var1][$var2] ?? null;

    return $GLOBALS['config'][$var1] ?? null;
}
